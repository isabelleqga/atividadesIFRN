...
if(isset($_POST['nome'])){
    ...
    if($csenha!=$senha){
        ...
        location.href = 'perfil-editar-master.php?codigo=codigousuario';
        </script>";
    }else{
        ...
        echo
            "<script>
            location.href = 'visuclientes.php';
            </script>";
    }
}
                    ...
                    <div class="content">
                        <form action = "?" method = "POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-2 ">
                                    <center>
                                        <img class="img-circle img-no-padding img-responsive " width = "70%" src="<?php echo $resultadocod['USU_FOTO']."?".$versaoImagem;?>" alt="..."/>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <input type="hidden" value="<?php echo $resultadocod['USU_CODIGO'];?>" class="form-control border-input" name = "codigousuario" required>
                            <div class="text-right">
                                <button type="submit" class="btn btn-info btn-fill btn-wd"><i class="ti-save"></i> Salvar</button>
                                <a style="background-color:#954A4A;border-color: #954A4A; float: left" class="btn btn-info btn-fill btn-wd" href="visuclientes.php"><i class="ti ti-arrow-circle-left ti-fill"></i>  Voltar </a>
                            </div>
