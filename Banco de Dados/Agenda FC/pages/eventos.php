...
<div class="container-fluid">
    ...
    <a  class="btn btn-info btn-fill btn-wd" href = "calendario-agenda.php?codigo=<?php echo $codigoagenda; ?>"><i class="ti-calendar"></i>  Ver Calendário
    </a>
