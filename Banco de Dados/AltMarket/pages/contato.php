            ...
            <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input type="text" class="form-control border-input" name = "nome" value="<?php echo $dadosPerfil['USU_NOME']; ?>" READONLY style="background-color: #D1D1D1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" class="form-control border-input" name = "email" value="<?php echo $dadosPerfil['USU_EMAIL']; ?>" READONLY style="background-color: #D1D1D1">
                                            </div>
                                        </div>
                                    </div>
         <div class="row">
