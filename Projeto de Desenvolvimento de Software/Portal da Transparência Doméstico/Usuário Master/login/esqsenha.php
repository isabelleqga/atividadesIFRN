        ...
        <div class="col-md-12">
            ...
            <div class="text-left">
                    <div style="color: black;background:transparent;border:transparent;" onmouseover="showMessage()" onmouseout="hideMessage()">precisa de ajuda?
                        <div class="mensagem ml-2" style="background:white; display:none; position:absolute; top: 68%;margin: auto; maxwidth:500px; height:30px; border:transparent;">
                            Insira o email referente à conta que deseja recuperar a senha, depois envie.
                        </div>
                    </div>
                </div>
                <br>
