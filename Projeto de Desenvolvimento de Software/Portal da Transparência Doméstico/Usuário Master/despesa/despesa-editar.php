        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control border-input" style="background-color: white; border-radius: 0px; border-color: #c7d4e2; border-width: 3px" value="Comprei os legumes, as verduras e umas carnes para passar a semana." name="Descrição">
                    </div>
                </div>             
            </div>
            <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input style="background-color: white; border-radius: 0px; border-color: #c7d4e2; border-width: 3px" class="form-control border-input" value="R$69,00">
                </div>
            </div> 
            <div class="col-md-4">
                <div class="form-group">
                    <label>Data<span style="color: #E53935">*</span></label>
                    <input class="form-control border-input" id="date" type="date" style="background-color: white; border-radius: 0px; border-color: #c7d4e2; border-width: 3px" value="dd/mm/aaaa" name="Data">
                </div>
            </div>
            <div class="col-md-4"> 
                <div class="form-group">
