...
include("../includes/verifica-visitante.php");
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-wrapper" style="background-color: #0D1F26;">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="sobrenos-visitante.php" style="color:#FF5733" title="Sobre nós">
                            <i class="ti-info"></i>
                            <p style="color: transparent;"> .</p>
                        </a>
                    </li>
                    <li>
                        <a href="condicoes-visitante.php" style="color:#FF5733" title="Condições de aluguel">
                    ...
                    <li>
                        <a href="contato-visitante.php" style="color:#FF5733" title="Contato">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <center>
                                        ...
                                        <a href="cardmoto-visitante.php?codigo=<?php echo $resultado['MOT_CODIGO']; ?>" class="btn btn-primary" style="margin: 10px; margin-bottom: 15px;">Ver moto</a>
                                    </center>
                                </div>
                            </div>
                        </div>
