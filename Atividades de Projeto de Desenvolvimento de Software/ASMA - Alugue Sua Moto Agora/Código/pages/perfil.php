...
include("../includes/verifica-logado.php");
include("../includes/top.php");
$codigousuario = intval($_SESSION['codigousuario']);
$versaoImagem = uniqid(time());
...
$resultadoPerfil = $perfil->fetch_assoc();
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input type="text" class="form-control border-input" name="nome" value="<?php echo $resultadoPerfil['USU_NOME']; ?>" READONLY style="background:#D1D1D1;">
                                    </div>
                                </div>
                                <div class="col-md-2 ">
                                    <center>
                                        <img class="img-circle img-no-padding img-responsive " width = "70%" src="<?php echo $resultadoPerfil['USU_FOTO']."?".$versaoImagem; ?>" alt="..."/>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control border-input" name = "email" value="<?php echo $resultadoPerfil['USU_EMAIL']; ?>" READONLY style="background:#D1D1D1;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nome de Usuário</label>
                                        <input type="text" class="form-control border-input" name = "usuario" value="<?php echo $resultadoPerfil['USU_USUARIO']; ?>" READONLY style="background:#D1D1D1;">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" class="form-control border-input" name = "cpf" value="<?php echo $resultadoPerfil['USU_CPF']; ?>" READONLY style="background:#D1D1D1;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Telefone</label>
                                        <input type="text" class="form-control border-input" name = "telefone" value="<?php echo $resultadoPerfil['USU_TELEFONE']; ?>" READONLY style="background:#D1D1D1;">
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <a class="btn btn-info btn-fill btn-wd" href="perfil-editar.php?codigo=<?php echo $resultadoPerfil['USU_CODIGO']; ?>"><i class="ti-pencil"></i> Editar </a> 
                                <a style="background-color:#954A4A;border-color: #954A4A; float: left" class="btn btn-info btn-fill btn-wd" href="?excluir=<?php echo $resultadoPerfil['USU_CODIGO']; ?>"><i class="ti-trash"></i>  Desabilitar </a>                      
                            </div>
                            <div class="row">
                                <div class="col-md-12">
