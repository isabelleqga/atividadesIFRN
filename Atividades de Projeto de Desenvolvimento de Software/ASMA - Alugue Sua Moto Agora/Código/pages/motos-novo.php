                                    ...
                                    <form action = "?" method = "POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input name = "potencia" class="form-control border-input" placeholder=" 50 cv a 60 cv" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Altura do banco</label>
                                                <input name = "alturaBanco" class="form-control border-input" placeholder=" 750 mm a 790 mm" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Peso</label>
                                                <input name = "peso" class="form-control border-input" placeholder=" 190 kg a 215 kg" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Diária</label>
                                                <input type="text" name = "diaria" class="form-control border-input" placeholder=" 430.00" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Fim de semana</label>
                                                <input type="text" name = "fimSemana" class="form-control border-input" placeholder=" 1095.00" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
