...
$consultaTodas = $MySQLi->query("SELECT * FROM TB_MOTOS ORDER BY MOT_MODELO");
?>
<div class="main-panel">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <?php while($resultadoTodas=$consultaTodas->fetch_assoc()) { ?>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><?php echo $resultadoTodas['MOT_MODELO']; ?></p>
                                            <p style="color: #A9A9A9;"><?php echo $resultadoTodas['MOT_PLACA']; ?></p>
                                            <a href="vermotom.php?codigo=<?php echo $resultadoTodas['MOT_CODIGO']; ?>">
                                                <i class="ti-link"></i>
                                            </a>
                                            <a href="motos-editar.php?codigo=<?php echo $resultadoTodas['MOT_CODIGO']; ?>">
                                                <i class="ti-pencil"></i>
                                            </a>
                                        </div>
                                    </div>
