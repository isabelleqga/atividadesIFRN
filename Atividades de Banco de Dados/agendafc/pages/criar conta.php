...
if(isset($_POST['nome'])){
    ...
    while($check=$checagem->fetch_assoc()){
        ...
        $msg = 1;
    }else if($senhaconfirmacao==$senha&&$msg==0){
...
<form action = "?" method = "POST">
    <div class="row">
            <div class="author">
                <center>
                <img class="img-circle img-no-padding img-responsive" width = "20%" src="../assets/img/agendinha.png" alt="..."/> 
                </center>              
            </div>      
        </div>
        <br>
        ...
        ?>
                                   ...
                                   <br>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Criar</button><br><br>
