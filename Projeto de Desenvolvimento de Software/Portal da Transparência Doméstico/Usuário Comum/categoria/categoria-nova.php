...
<div class="container-fluid">
    <div class="col-md-12"><h3>Nova Categoria</h3>
        <div class="card">
            <div class="content">
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input class="form-control border-input" style="background-color: white; border-radius: 0px; border-color: #c7d4e2; border-width: 3px" placeholder="Digite uma nova categoria de despesa. Ex.: Academia">
                                </div>
                            </div>  
                            <div class="col-md-6">
                                <div class="form-group">
